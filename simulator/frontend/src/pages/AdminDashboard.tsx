...
function AdminHomePage({ items }: { items: MenuItem[] }) {
  ...
  return (
    <div>
      <div className="page-header">
        ...
        <p>
          Full access to the AI Hospital IVR System.
...
export default function AdminDashboard() {
  ...
  // Remap sidebar items to admin-prefixed routes
  ...
  return (
    <div className="app-layout">
      ...
      <main className="main-content">
        <Routes>
          <Route path="dashboard" element={<AdminHomePage items={menuItems} />} />
